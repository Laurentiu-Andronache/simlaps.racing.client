    ...
    "circuit_of_the_americas_national": {
        ...
        "configs": {
            "national": {
                ...
                "aliases": ["national"],
                "corners": [
                    {"id": 1, "name": "Turn 1", "start": 0.020, "end": 0.060},
                    {"id": 2, "name": "Turn 2", "start": 0.080, "end": 0.110},
                    {"id": 3, "name": "Turn 3", "start": 0.130, "end": 0.150},
                    {"id": 4, "name": "Turn 4", "start": 0.150, "end": 0.170},
                    {"id": 5, "name": "Turn 5", "start": 0.170, "end": 0.190},
                    {"id": 6, "name": "Turn 6", "start": 0.190, "end": 0.210},
                    {"id": 7, "name": "Turn 7", "start": 0.250, "end": 0.280},
                    {"id": 8, "name": "Turn 8", "start": 0.280, "end": 0.310},
                    {"id": 9, "name": "Turn 9", "start": 0.310, "end": 0.340},
                    {"id": 10, "name": "Turn 10", "start": 0.380, "end": 0.400},
    ...
    "mount_panorama": {
        ...
        "configs": {
            "full": {
                ...
                "aliases": ["full"],
                "corners": [
                    {"id": 1, "name": "Turn 1", "start": 0.010, "end": 0.050},
                    {"id": 2, "name": "Turn 2", "start": 0.080, "end": 0.120},
                    {"id": 3, "name": "Turn 3", "start": 0.150, "end": 0.180},
                    {"id": 4, "name": "Turn 4", "start": 0.200, "end": 0.250},
                    {"id": 5, "name": "Turn 5", "start": 0.280, "end": 0.310},
                    {"id": 6, "name": "Turn 6", "start": 0.330, "end": 0.350},
                    {"id": 7, "name": "Turn 7", "start": 0.350, "end": 0.380},
                    {"id": 8, "name": "Turn 8", "start": 0.410, "end": 0.440},
                    {"id": 9, "name": "Turn 9", "start": 0.460, "end": 0.490},
                    {"id": 10, "name": "Turn 10", "start": 0.520, "end": 0.560},
                    {"id": 11, "name": "Turn 11", "start": 0.600, "end": 0.630},
                    {"id": 12, "name": "Turn 12", "start": 0.650, "end": 0.670},
                    {"id": 13, "name": "Turn 13", "start": 0.670, "end": 0.700},
                    {"id": 14, "name": "Turn 14", "start": 0.720, "end": 0.760},
                    {"id": 15, "name": "Turn 15", "start": 0.780, "end": 0.800},
                    {"id": 16, "name": "Turn 16", "start": 0.800, "end": 0.820},
                    {"id": 17, "name": "Turn 17", "start": 0.840, "end": 0.860},
                    {"id": 18, "name": "Turn 18", "start": 0.860, "end": 0.880},
                    {"id": 19, "name": "Turn 19", "start": 0.900, "end": 0.920},
                    {"id": 20, "name": "Turn 20", "start": 0.930, "end": 0.950},
                    {"id": 21, "name": "Turn 21", "start": 0.960, "end": 0.975},
                    {"id": 22, "name": "Turn 22", "start": 0.975, "end": 0.985},
                    {"id": 23, "name": "Turn 23", "start": 0.985, "end": 0.995},
                ],
            },
        },
    },
        ...
        "configs": {
            "fosters": {
                ...
                "corners": [
                    ...
                    {"id": 2, "name": "Denton's", "start": 0.120, "end": 0.140},
                    {"id": 3, "name": "Cascades (Partial)", "start": 0.140, "end": 0.200},
                    {"id": 4, "name": "Island Bend", "start": 0.220, "end": 0.280},
                    {"id": 5, "name": "Shell Oils", "start": 0.320, "end": 0.380},
                    {"id": 6, "name": "Britten's 1", "start": 0.450, "end": 0.480},
                    {"id": 7, "name": "Britten's 2", "start": 0.480, "end": 0.510},
                    {"id": 8, "name": "Britten's 3", "start": 0.510, "end": 0.540},
                    {"id": 9, "name": "Knickerbrook", "start": 0.650, "end": 0.720},
                ],
            },
        },
    },
    "oulton_park_international": {
        ...
        "configs": {
            "international": {
                ...
                "corners": [
                    {"id": 1, "name": "Old Hall", "start": 0.020, "end": 0.080},
                    {"id": 2, "name": "Cascades", "start": 0.150, "end": 0.200},
                    {"id": 3, "name": "Island Bend", "start": 0.280, "end": 0.340},
                    {"id": 4, "name": "Shell Oils Corner", "start": 0.420, "end": 0.480},
                    {"id": 5, "name": "Britten's 1", "start": 0.550, "end": 0.580},
                    {"id": 6, "name": "Britten's 2", "start": 0.580, "end": 0.610},
                    {"id": 7, "name": "Hislops 1", "start": 0.700, "end": 0.730},
                    {"id": 8, "name": "Hislops 2", "start": 0.730, "end": 0.760},
                    {"id": 9, "name": "Knickerbrook", "start": 0.800, "end": 0.850},
                    {"id": 10, "name": "Druids", "start": 0.900, "end": 0.940},
                    {"id": 11, "name": "Lodge Corner", "start": 0.970, "end": 0.990},
                ],
            },
        },
    },
    "red_bull_ring": {
        ...
        "configs": {
            "full": {
                ...
                "aliases": ["full", "gp"],
                "corners": [
                    {"id": 1, "name": "Castrol Edge", "start": 0.020, "end": 0.080},
                    {"id": 2, "name": "Turn 2 Kink", "start": 0.150, "end": 0.170},
                    {"id": 3, "name": "Remus Hairpin", "start": 0.200, "end": 0.260},
                    {"id": 4, "name": "Schlossgold", "start": 0.350, "end": 0.400},
                    {"id": 5, "name": "Turn 5 Kink", "start": 0.500, "end": 0.520},
                    {"id": 6, "name": "Rauch Kurve", "start": 0.550, "end": 0.600},
                    {"id": 7, "name": "Würth Kurve", "start": 0.600, "end": 0.650},
                    {"id": 8, "name": "Rindt", "start": 0.750, "end": 0.800},
                    {"id": 9, "name": "Red Bull Mobile", "start": 0.850, "end": 0.900},
                    {"id": 10, "name": "Finish", "start": 0.950, "end": 0.970},
                ],
            },
            "national": {
                "name": "National",
        ...
        "configs": {
            "full": {
                ...
                "corners": [
                    ...
                    {"id": 7, "name": "Turn 7", "start": 0.220, "end": 0.250},
                    {"id": 8, "name": "Degner 1", "start": 0.300, "end": 0.330},
                    {"id": 9, "name": "Degner 2", "start": 0.330, "end": 0.360},
                    {"id": 10, "name": "Hairpin", "start": 0.400, "end": 0.440},
                    {"id": 11, "name": "Spoon 1", "start": 0.500, "end": 0.540},
                    {"id": 12, "name": "Spoon 2", "start": 0.540, "end": 0.580},
                    {"id": 13, "name": "130R", "start": 0.650, "end": 0.700},
                    {"id": 14, "name": "Casio Chicane 1", "start": 0.750, "end": 0.780},
                    {"id": 15, "name": "Casio Chicane 2", "start": 0.780, "end": 0.810},
                    {"id": 16, "name": "Turn 16", "start": 0.850, "end": 0.870},
                    {"id": 17, "name": "Turn 17", "start": 0.870, "end": 0.890},
                    {"id": 18, "name": "Turn 18", "start": 0.950, "end": 0.980},
                ],
            },
        },
    },
        ...
        "configs": {
            "full": {
                ...
                "corners": [
                    ...
                    {"id": 2, "name": "Turn 2", "start": 0.150, "end": 0.200},
                    {"id": 3, "name": "Turn 3", "start": 0.250, "end": 0.300},
                    {"id": 4, "name": "Turn 4", "start": 0.350, "end": 0.400},
                    {"id": 5, "name": "Inner Loop 1", "start": 0.500, "end": 0.530},
                    {"id": 6, "name": "Inner Loop 2", "start": 0.530, "end": 0.560},
                    {"id": 7, "name": "Carousel (Turn 5)", "start": 0.650, "end": 0.750},
                    {"id": 8, "name": "Turn 6", "start": 0.850, "end": 0.900},
                    {"id": 9, "name": "Turn 7", "start": 0.950, "end": 0.980},
                ],
            },
        },
    },
...
def get_track_catalog() -> dict:
    """Get the full track catalog."""
    return TRACK_CATALOG


def get_track_names() -> list:
    """Get list of available track names."""
    return list(TRACK_CATALOG.keys())


def get_track_by_key(track_key: str) -> dict:
    """Get track info by key."""
    return TRACK_CATALOG.get(track_key)


def get_track_configs(track_key: str) -> dict:
    """Get available configs for a track."""
    track = TRACK_CATALOG.get(track_key)
    if track:
        return track.get("configs", {})
    return {}
