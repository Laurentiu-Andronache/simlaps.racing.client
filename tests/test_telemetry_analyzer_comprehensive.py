...
class TestTelemetryAnalyzer:
    ...
    async def test_analyze_auto_corners_reaches_coaching_outputs(self, tmp_path):
        ...
        result = await TelemetryAnalyzer(output_dir=str(tmp_path)).analyze(
            ...
            game_lap_boundaries=[(100, None, 0, "OUTLAP"), (200, None, 1, "VALID"), (300, None, 2, "VALID")],
    ...
    async def test_analyze_with_game_lap_markers_uses_log_lap_times(self):
        ...
        # Explicit completed verdicts accompany these authoritative times.
        game_markers = [
            (50, 153396, 1, "VALID"),
            (100, 153309, 2, "VALID"),
            (150, 152460, 3, "VALID"),
