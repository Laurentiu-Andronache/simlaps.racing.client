...
async def test_valid_timed_lap_after_rejected_pit_prefix_is_not_suppressed(tmp_path):
    ...
    parser.context.player_id = "76561198000000000"
...
async def test_short_rejected_pit_prefix_keeps_next_circuit_hidden_as_outlap(
    ...
    assert sessions[0].laps[0].is_valid is False
